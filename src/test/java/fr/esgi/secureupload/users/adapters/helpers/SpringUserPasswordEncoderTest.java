...
@SpringBootTest
public class SpringUserPasswordEncoderTest {

    UserPasswordEncoder encoder;

    public SpringUserPasswordEncoderTest(@Autowired PasswordEncoder springEncoder){
        this.encoder = new SpringUserPasswordEncoder(springEncoder);
    }
